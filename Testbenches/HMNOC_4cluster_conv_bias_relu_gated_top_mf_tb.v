...
module HMNOC_4cluster_wpsum_bias_relu_gated_mf_tb();
    ...
    reg signed [DATA_BITWIDTH-1:0] bias_west_0;
    reg signed [DATA_BITWIDTH-1:0] bias_west_1;
    reg signed [DATA_BITWIDTH-1:0] bias_east_0;
    reg signed [DATA_BITWIDTH-1:0] bias_east_1;
    reg act_en;


	reg [DATA_BITWIDTH-1:0] w_bias_west_0;
	reg [DATA_BITWIDTH-1:0] w_bias_west_1;
	reg [DATA_BITWIDTH-1:0] w_bias_east_0;
	reg [DATA_BITWIDTH-1:0] w_bias_east_1;
	
reg signed [15:0] gauss3x3 [0:8];

initial begin
    gauss3x3[0] = 16'sd1;  // (0,0)
    gauss3x3[1] = 16'sd2;  // (0,1)
    gauss3x3[2] = 16'sd1;  // (0,2)

    gauss3x3[3] = 16'sd2;  // (1,0)
    gauss3x3[4] = 16'sd4;  // (1,1)
    gauss3x3[5] = 16'sd2;  // (1,2)

    gauss3x3[6] = 16'sd1;  // (2,0)
    gauss3x3[7] = 16'sd2;  // (2,1)
    gauss3x3[8] = 16'sd1;  // (2,2)
end
	...
	// ======================================================
	initial begin
		$dumpfile("/home/abhiram/Projects/Nithya-Project/Power_Analysis/Simulations/HMNOC_4cluster_wpsum_bias_relu_mf_tb_gated.vcd");

		// Dump entire testbench + DUT hierarchy
		$dumpvars(0, HMNOC_4cluster_wpsum_bias_relu_gated_mf_tb);
...
HMNOC_4cluster_wpsum_bias_relu_top
#(
...
HMNOC_4cluster_0   // instance name can stay
(
   // ALL PORT CONNECTIONS STAY IDENTICAL 
   .clk(clk),
   .reset(reset),
   .start(start),
   ...
   .router_mode_east_1_psum(router_mode_east_1_psum),
	...
	for(m=0;m<size/30;m=m+1) begin
		...
		handle_west_0=$fopen("/home/abhiram/Projects/Nithya-Project/Power_Analysis/lena_gated_mf_west_0.txt");
		handle_west_1=$fopen("/home/abhiram/Projects/Nithya-Project/Power_Analysis/lena_gated_mf_west_1.txt");
		handle_east_0=$fopen("/home/abhiram/Projects/Nithya-Project/Power_Analysis/lena_gated_mf_east_0.txt");
		handle_east_1=$fopen("/home/abhiram/Projects/Nithya-Project/Power_Analysis/lena_gated_mf_east_1.txt");
