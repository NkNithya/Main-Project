...
set NETLIST Baseline_Architecture_RTL/synth_hd.v
set TIMING_LEF  skywater-pdk/libraries/sky130_fd_sc_hd/latest/timing/sky130_fd_sc_hd__ss_100C_1v60.lib
...
read_vcd Simulations/HMNOC_4cluster_wpsum_bias_relu_mf_tb_baseline.vcd

# =========================
# Report
# =========================
set rpt_file "Reports/power_report_baseline_sc_hd.txt"

# Create file and write heading
set fp [open $rpt_file "w"]
puts $fp "=================================================="
puts $fp "   HMNOC 4-Cluster WPSUM + BIAS + RELU - POWER REPORT (sc_hd)"
puts $fp "=================================================="
